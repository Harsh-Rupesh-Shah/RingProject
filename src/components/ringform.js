      ...
      <form>
        <div className="input-form">
          ...
          <div className="input-form">
            ...
            <Dropdown
              onSelect={(eventKey) =>
                handleDropdownSelect("ringSize", eventKey)
              }
            >
          ...
          <div className="input-form">
            <label
              ...
              htmlFor="dropdown-shank-diameter"
            >
              Shank Diameter
            </label>
            <Dropdown
          ...
          <div className="input-form">
            <label
              className="form-label bold"
              htmlFor="dropdown-solitaire-shape"
            >
              Solitaire Shape
            </label>
            <Dropdown
          ...
          <div className="input-form">
            ...
            <Dropdown
              onSelect={(eventKey) =>
                handleDropdownSelect("solitaire", eventKey)
              }
            >
          ...
          <div className="input-form">
            ...
            >
              ...
              <Dropdown.Menu className="show-dropdown">
                <Dropdown.Item eventKey="Single Halo">
                  Single Halo
                </Dropdown.Item>
                <Dropdown.Item eventKey="Double Halo">
                  Double Halo
                </Dropdown.Item>
              </Dropdown.Menu>
            </Dropdown>
          ...
          <div className="input-form">
            ...
            >
              ...
              <Dropdown.Menu className="show-dropdown">
                ...
                <Dropdown.Item eventKey="Yellow Gold">
                  Yellow Gold
                </Dropdown.Item>
